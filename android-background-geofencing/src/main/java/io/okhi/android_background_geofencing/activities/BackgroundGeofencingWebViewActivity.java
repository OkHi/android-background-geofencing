package io.okhi.android_background_geofencing.activities;
...
import io.okhi.android_background_geofencing.interfaces.WebViewAppInterface;
...
public class BackgroundGeofencingWebViewActivity extends AppCompatActivity {
  ...
  private void setupWebView(){
    ...
    webView.addJavascriptInterface(new WebViewAppInterface(BackgroundGeofencingWebViewActivity.this), "Android");
...
//      payload.put("locations", locationIds);
      ...
      BackgroundGeofenceUtil.log(getApplicationContext(), "BGWEBVIEW", webViewLaunchPayload);
    }
    catch (Exception e){
      e.printStackTrace();
      finish();
  ...
  public void receiveMessage(String result) {
    try {
      ...
      Log.v("BackgroundGeofence", message + "<<<<");
      switch (message) {
