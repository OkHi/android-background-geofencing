...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    okHi = new OkHi(this);
    try {
      OkPreference.setItem("okcollect-launch-payload", "{\"message\":\"verification_status\",\"payload\":{\"style\":{\"base\":{\"color\":\"#ba0c2f\",\"logo\":\"https://cdn.okhi.co/icon.png\"}},\"user\":{\"firstName\":\"Julius\",\"lastName\":\"Kiano\",\"phone\":\"+254700110590\"},\"auth\":{\"authToken\":\"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..PvKW8WzJWTiRyHMxeDgssnTxg_8PNOFkV_iEKuCCzmjv-fmNaQNOA0VxlDf920Gafv5fX0PycKABjDgC2SQFwDqF3Sce5pKj36jmVya0yib4iXcgmf1L9rsgA1C1b0JFWam6TnWjy9Spau9gZqrWy-uErVu1B4PHrrzO7mpwL0k\"},\"context\":{\"container\":{\"name\":\"okCollectMobileAndroid\",\"version\":\"version\"},\"developer\":{\"name\":\"okhi\"},\"library\":{\"name\":\"okCollectMobileAndroid\",\"version\":\"version\"},\"platform\":{\"name\":\"android\"},\"permissions\":{\"location\":\"always\"},\"device\":{\"manufacturer\":\"OnePlus\",\"model\":\"HD1900\"},\"locationServicesAvailable\":false},\"config\":{\"streetView\":true,\"protectedApps\":false,\"addressTypes\":{\"work\":true,\"home\":true},\"appBar\":{\"visible\":true,\"color\":\"#ba0c2f\"}},\"locations\":[{\"id\":\"TQm7v9tQGe\"}]},\"url\":\"https://manager-v5.okhi.io\"}", getApplicationContext());
    ...
    final Button button = findViewById(R.id.location_request);
...
//            if (result) startGeofence();
    ...
    BackgroundGeofencingWebHook geofenceWebHook = new BackgroundGeofencingWebHook(
      "https://3439-41-90-189-44.ngrok.io/transits",
      10000,
      headers,
      null,
    ...
    BackgroundGeofencingWebHook deviceMetaWebHook = new BackgroundGeofencingWebHook(
      "https://3439-41-90-189-44.ngrok.io/device-meta",
      10000,
      headers,
      null,
    ...
    BackgroundGeofencingWebHook stopVerificationWebHook = new BackgroundGeofencingWebHook(
      "https://3439-41-90-189-44.ngrok.io/stop/verification",
      10000,
      headers,
      null,
      WebHookType.STOP,
